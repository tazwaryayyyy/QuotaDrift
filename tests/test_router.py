...
class TestRouterFailover:
    ...
    async def test_primary_provider_success(self, mock_router):
        ...
        mock_router_instance.acompletion.return_value = mock_response
    ...
    async def test_failover_chain(self, mock_router):
        ...
        mock_router_instance.acompletion.side_effect = [
            rate_limit_error,
            success_response
        ]
    ...
    async def test_provider_timeout_handling(self, mock_router):
        ...
        # Mock timeout error
        mock_router_instance.acompletion.side_effect = asyncio.TimeoutError("Request timeout")
